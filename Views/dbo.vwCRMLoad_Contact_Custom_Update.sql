...
, b.emailaddress1																												  --,c.emailaddress1
, b.mobilephone																													  --,c.mobilephone
, b.telephone2																													  --,c.telephone2
, b.emailaddress2																												  --,c.emailaddress2
, b.emailaddress3																												  --,c.emailaddress3
...
--, CASE WHEN	(b.New_Turnkey_HouseholdIncome IS NOT NULL AND  HASHBYTES('SHA2_256',ISNULL(LTRIM(RTRIM(b.New_Turnkey_HouseholdIncome)),c.str_externalhouseholdincome) )  <> HASHBYTES('SHA2_256',ISNULL(LTRIM(RTRIM(CAST(c.str_externalhouseholdincome AS NVARCHAR(MAX)))),'')))				then 1 else 0 end as str_externalhouseholdincome
...
AND  (1=2
	...
	OR (b.New_Turnkey_HouseholdIncome IS NOT NULL AND  HASHBYTES('SHA2_256',ISNULL(LTRIM(RTRIM(b.New_Turnkey_HouseholdIncome)),c.str_externalhouseholdincome) )  <> HASHBYTES('SHA2_256',ISNULL(LTRIM(RTRIM(CAST(c.str_externalhouseholdincome AS NVARCHAR(MAX)))),'')))
