...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__ForceMerg__Creat__14E61A24] DEFAULT (getdate()),
[CreatedBy] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Complete] [bit] NULL CONSTRAINT [DF__ForceMerg__Compl__15DA3E5D] DEFAULT ((0)),
